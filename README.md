 ...
 **Design Theme:** Modern Professional with Earth Tones ; a clean, accessible portfolio using a forest green and waramber palette to convey trust and creativity. Includes dark/light mode toggle.
 ...
 **Challenge:** When clicking navigation links, the fixed header covered the top part of each section (e.g., "About Me" 
 heading was hidden behind the header).
